...
contract StarNotary is ERC721 {
    ...
    // As done in contract of CryptoKitties https://etherscan.io/address/0x06012c8cf97bead5deae237070f9587f8e7a266d#code
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "You can not exchange a star that is not yours.");
        //The line above is the same as the if-clause below
        /*if(ownerOf(_tokenId1) != msg.sender && ownerOf(_tokenId2) != msg.sender) {
            revert("You can not exchange a star that is not yours.");
        }*/
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require (ownerOf(_tokenId) == msg.sender, "You can not transfer a star that is not yours.");
